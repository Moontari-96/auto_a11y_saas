            ...
            <div className="flex min-h-screen bg-slate-50/50">
                ...
                <aside className="fixed inset-y-0 left-0 w-64 border-r bg-white shadow-sm transition-all duration-300">
                    ...
                    <div className="absolute bottom-4 w-full px-4">
                        ...
                        <Button
                            variant="ghost"
                            className="w-full flex items-center justify-start gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 transition-colors mt-2"
                            onClick={logout}
                        >
